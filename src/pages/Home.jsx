...
const Home = () => {
  ...
  const heroBackgroundImage = getAssetPath('/images/singapore-skyline.jpg');

  // Consola para debug - verifica que la ruta sea correcta
  console.log('Ruta de imagen hero:', heroBackgroundImage);
    ...
    <div className="theme-transition">
      ...
      <div className="hero-container">
        <img 
          ...
          alt="Singapur de noche" 
          className="hero-bg-image"
        />
        <div className="hero-content-wrapper">
          <div className="hero-text-container">
            <h1 className="display-4 fw-bold">Singapur: Una Mirada Profunda</h1>
            <p className="lead">Descubre el fascinante contraste entre tradición y modernidad en esta pequeña nación insular del Sudeste Asiático</p>
